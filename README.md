...
以下截图来自项目《软件说明书》中的微信小程序实测页面。系统会同时展示识别类别、置信度、严重程度、病害描述及防治建议。

<table>
  <tr>
    <td align="center">
      <img src="images/neck-blast-result.png" alt="Neck_Blast 水稻穗颈瘟识别结果" width="360"><br>
      <strong>Neck_Blast 识别结果</strong>
    </td>
    <td align="center">
      <img src="images/brown-spot-result.png" alt="Brown Spot 水稻胡麻斑病识别结果" width="360"><br>
      <strong>Brown Spot 识别结果</strong>
    </td>
  </tr>
</table>
